...
def args_parser():
	...
	parser.add_argument('--dataset', default='UCM', type=str, choices=['AID', 'UCM', 'OPTIMAL31', 'WHU', 'NWPU-RESISC45', 'RSSCN7'])
	...
	# model alexnet
	parser.add_argument('--arch', default='resnet18', type=str, choices=['alexnet', 'resnet18', 'googlenet', 'vgg16'])
